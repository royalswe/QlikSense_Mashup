...
Modified by Roy Nilsson 2/19/2018
...
*/
define(["jquery", "qlik", "./scripts/d3.min.js", "./scripts/lasso_adj.js", "css!./styles/bi-irregular-2dim-heatmap.css", "./scripts/irregularUtils.js"],
                            ...
                            options: {
                                ...
                                items: {   
                                    ...
                                    squaresMaxSize: {
                                        ref: "squaresMaxSize",
                                        type: "integer",
                                        label: "Maximum square size in px",
                                        defaultValue: 100,
                                        expression: "optional"
                                    }
                                }
            ...
            paint: function ($element, layout) { // prevent multiple paint() calls
                ...
                function heatMap($element, layout, fullMatrix, _this, ref) {
                    ...
                    var viz2DimHeatmap = function (_this, app, id, data, qDimensionType, qDimSort, width, height, colorpalette, dimensionLabels,
                        ...
                        if(gridSize > layout.squaresMaxSize){ gridSize = layout.squaresMaxSize; } // max square size
                        ...
                        if (dim2LabelRotation) {
                            ...
                            var dim2Labels = svg_g.selectAll()
                                ...
                                .enter().append("text")
                                .text(function (d) {
                                    return d.slice(0,2) + d.slice(2, gridSize / 10); // strip down text to fit the squares minimum 2 characters
                                })
                                .attr("x", function (d, i) {
                                    return i * gridSize;
                                })
